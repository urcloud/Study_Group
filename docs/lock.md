...
> 비유 예시
> 
> 기숙사에 살 때 하나의 화장실이 있고, 그 앞에 공용 열쇠가 걸려 있음
> 
> 누구든 화장실을 쓸 때 해당 열쇠를 들고 들어가야 함
> 
> 열쇠가 없으면 기다려야하고, 화장실에서 나오면 열쇠를 다시 걸어두어야 다른 사람이 사용할 수 있음
> 
> 이때 열쇠: 분산락, 화장실: 공유자원, 여러명의 학생: 서버 또는 애플리케이션 인스턴스
> 
> 쇼핑몰에서 인기상품 1개 남았을 때 동시에 100명이 주문 버튼을 누르는 등의 상황에 사용됨
> 
> 한 번에 한 서버만 재고 감소 로직을 실행할 수 있기 때문
